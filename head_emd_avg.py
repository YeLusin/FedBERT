...
def fed_avg(args):
    ...
    global_encoder_lm_head_weight = copy.deepcopy(model_0['model']["encoder.lm_head.weight"])
    global_encoder_lm_head_bias = copy.deepcopy(model_0['model']["encoder.lm_head.bias"])
    global_encoder_lm_head_dense_weight = copy.deepcopy(model_0['model']["encoder.lm_head.dense.weight"])
    global_encoder_lm_head_dense_bias = copy.deepcopy(model_0['model']["encoder.lm_head.dense.bias"])
    global_encoder_lm_head_norm_weight = copy.deepcopy(model_0['model']["encoder.lm_head.layer_norm.weight"])
    global_encoder_lm_head_norm_bias = copy.deepcopy(model_0['model']["encoder.lm_head.layer_norm.bias"])
    ...
    for client in range(1, number_client):
        ...
        global_encoder_lm_head_weight += copy.deepcopy(model['model']["encoder.lm_head.weight"])
        global_encoder_lm_head_bias += copy.deepcopy(model['model']["encoder.lm_head.bias"])
        global_encoder_lm_head_dense_weight += copy.deepcopy(model['model']["encoder.lm_head.dense.weight"])
        global_encoder_lm_head_dense_bias += copy.deepcopy(model['model']["encoder.lm_head.dense.bias"])
        global_encoder_lm_head_norm_weight += copy.deepcopy(model['model']["encoder.lm_head.layer_norm.weight"])
        global_encoder_lm_head_norm_bias += copy.deepcopy(model['model']["encoder.lm_head.layer_norm.bias"])
    ...
    global_encoder_lm_head_weight /= number_client
    global_encoder_lm_head_bias /= number_client
    global_encoder_lm_head_dense_weight /= number_client
    global_encoder_lm_head_dense_bias /= number_client
    global_encoder_lm_head_norm_weight /= number_client
    global_encoder_lm_head_norm_bias /= number_client
    ...
    for client in range(0, number_client):
        ...
        model['model']["encoder.lm_head.weight"] = global_encoder_lm_head_weight
        model['model']["encoder.lm_head.bias"] = global_encoder_lm_head_bias
        model['model']["encoder.lm_head.dense.weight"] = global_encoder_lm_head_dense_weight
        model['model']["encoder.lm_head.dense.bias"] = global_encoder_lm_head_dense_bias
        model['model']["encoder.lm_head.layer_norm.weight"] = global_encoder_lm_head_norm_weight
        model['model']["encoder.lm_head.layer_norm.bias"] = global_encoder_lm_head_norm_bias
